...
function addTagForm($collectionHolder, $newLinkLi, $collectionHolderScore, $collectionHolderCoef, $deletelink) {
    ...
    $('#appbundle_survey_surveys_'+index+'_score').on('click', function(e) {
    	...
    	//for(var i = 0; i <= index; i++) { 
    		while(i  < nbScore) {
	    		if($('#appbundle_survey_surveys_'+i+'_score').length>0) 
	    		{
	    			var score = $('#appbundle_survey_surveys_'+i+'_score').val() * $('#appbundle_survey_surveys_'+i+'_coefficient').val();
	    			console.log('#appbundle_survey_surveys_'+i+'_score  ' +score)
